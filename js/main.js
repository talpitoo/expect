...
$(window).load(function () {
    if ($(window).width() >= 768) {
        var $headerImage = $('<img src="img/stanley-kubrick-2001-space-odyssey.jpg?ver=24012016">');
        $headerImage.bind('load', function () {
            $('header').css('background-image', 'linear-gradient(to right, rgba(0, 0, 0, 0.5), transparent), url(img/stanley-kubrick-2001-space-odyssey.jpg?ver=24012016)');
        });
    }
});
